...
export const FONT_LIST = [
  {
    ...
    name: '系统默认',
    file: null, // 使用系统默认字体
    preview: 'YuiTodo 任务清单',
    category: 'system',
  },
  {
    id: 'huakang',
    name: '华康少女',
    file: require('../../assets/fonts/华康少女文字W5.ttf'),
    preview: '今天也要加油呀',
    category: 'rounded',
  },
  {
    id: 'lianxing',
    name: '恋星圆体',
    file: require('../../assets/fonts/恋星圆体.ttf'),
    preview: '温柔待世界',
    category: 'rounded',
  },
  {
  ...
  },
  {
    id: 'fukai',
    name: '福楷',
    file: require('../../assets/fonts/字体家AI造字福楷.ttf'),
    preview: '硬朗端正楷书',
    category: 'kai',
  },
  {
    id: 'togalit',
    name: '托加里特',
    file: require('../../assets/fonts/托加里特体-medium.otf'),
  ...
  },
  {
    id: 'zcool-kuaile',
    name: '站酷快乐体',
    file: require('../../assets/fonts/ZCOOLKuaiLe-Regular.ttf'),
    preview: '快乐每一天',
    category: 'rounded',
  },
  {
    id: 'zcool-xiaowei',
    name: '站酷小薇体',
    file: require('../../assets/fonts/ZCOOLXiaoWei-Regular.ttf'),
    preview: '优雅小薇风格',
    category: 'serif',
  },
  {
    id: 'zcool-huangyou',
    name: '庆科黄油体',
    file: require('../../assets/fonts/ZCOOLQingKeHuangYou-Regular.ttf'),
    preview: '圆润黄油质感',
    category: 'rounded',
  },
];
